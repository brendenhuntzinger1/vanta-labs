...
export function CookieConsent({ initiallyOpen = false }: { initiallyOpen?: boolean }) {
  ...
  // Meta pixel and the Omnisend script are loaded on every page, ungated, by
  // the owner's decision (see components/meta-pixel.tsx,
  // components/omnisend-snippet.tsx and both policies); and the Google tag is
