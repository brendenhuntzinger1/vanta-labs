...
// ---------------------------------------------------------------------------
// VL-29 / VL-REV-01 — A RENEWAL IS A SALE, SO IT HAS TO BE AN ORDER.
//
...
//
// The rule these tests hold: a renewal charge that really took money writes a
// PAID membership order for the amount CAPTURED, exactly once per period.
// ---------------------------------------------------------------------------
...
vi.mock("@/lib/veyra-membership", () => ({
  startVeyraMembership: async () => ({ ok: true, membershipId: "veyra_sub_1" }),
