...
// caught it.
//
// The shared Supabase fake below is the reason they can live together: most of
// these bugs are about WHICH QUERIES GET ISSUED — how many pages, with which
// sort key, against which table — and none of those is visible from a return
// value alone. So the fake records the query objects and the tests assert on
// those, rather than on a number that happened to come out right.
// ---------------------------------------------------------------------------
