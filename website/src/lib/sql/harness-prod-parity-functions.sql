...
-- ---------------------------------------------------------------------------
revoke all on function public.admin_ops_summary(timestamptz, timestamptz) from public, anon, authenticated;
grant execute on function public.admin_ops_summary(timestamptz, timestamptz) to service_role;
revoke all on function public.admin_points_outstanding() from public, anon, authenticated;
grant execute on function public.admin_points_outstanding() to service_role;
revoke all on function public.current_auth_email() from public, anon, authenticated;
grant execute on function public.current_auth_email() to service_role;
