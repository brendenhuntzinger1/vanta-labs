...
Either way the tag is the narrowest of the five on what it is told. It does not report shopping actions at all: we do not tell Google which product pages you view, when you add an item to the cart, when you begin checkout, or when an order is paid, and it receives no product identifier, quantity, order value or currency. Nothing identifying you is sent at any consent setting. Google's own setup offers a field for your email address, under the name Enhanced Conversions; we do not use it, so Google receives neither a plain address nor a hash of one.

We do not run any advertising technology beyond the five named above. If we add one, this policy and our Cookie Policy will be updated to name the platform, the data shared and the purpose before it is switched on — as they were for the Google tag and the Meta Pixel above.
