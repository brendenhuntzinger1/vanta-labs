...
**Omnisend is present on every page, whether or not you accept cookies.** We use Omnisend for our email and text-message marketing, and its website script is loaded on every page without waiting for your choice on the cookie banner — the same decision we made for the Meta Pixel, and we are telling you this plainly rather than describing it as held back, because it is not. On every page it sends Omnisend your page views together with the technical data any web request carries — IP address, browser and device type, referring page — and sets two identifiers in your browser: one for the session, which expires after thirty minutes of inactivity, and one for the visitor, which lasts a year. Omnisend uses these to show our sign-up form, to let us see which pages our subscribers browse and send automated messages based on that browsing, and to connect a visit to your contact record if you sign up through one of its forms or arrive through a link in one of our marketing messages. It is told about page views only: it receives no shopping actions, product identifiers or order values, and this site never hands it your email address — Omnisend learns it only from you, when you subscribe. Omnisend processes what it receives in line with its own privacy policy.

**How to stop Omnisend.** Declining cookies does not stop the Omnisend script. You can block it with a content-blocking browser extension, unsubscribe from our marketing messages at any time, or ask us to stop matching your details using the contact details above.
...
**Omnisend — always present, and not controlled by this banner.** Omnisend sends our marketing emails and text messages, and its script loads on every page whether you accept or decline. It sets a session identifier that expires after thirty minutes of inactivity and a visitor identifier that lasts a year, and sends Omnisend the pages you view so it can show our sign-up form, let us see what our subscribers browse, and connect a visit to your contact record if you sign up through one of its forms or arrive through a link in one of our marketing messages. It is never told about shopping actions or order values, and this site never sends it your email address. Declining cookies does not stop it; see the Privacy Policy for how to opt out.
