...
## Sharing
Only with service providers that help us operate — payment processing, transactional email delivery (Resend), marketing email and SMS delivery (Omnisend), hosting, analytics and shipping — as needed to run the store, or as required by law.
