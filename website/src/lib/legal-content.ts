...
Information you provide at checkout and when contacting us (name, email, shipping address, order details), your mobile number if you choose to give it to us for text messages, and limited technical data such as device type, pages viewed, and referring website.
...
When you accept, five things run: our own first-party analytics, which records page views and store events to our own database; Vercel Analytics, a privacy-focused measurement service provided by our hosting provider; the TikTok Pixel; the Snap Pixel; and the Reddit Pixel. Three more — the Meta Pixel, the Google Ads tag and the Omnisend script — are present whether or not you accept, and each is described in its own section below so that nothing here overstates what declining does.
...
If you decline cookies, none of these three pixels are loaded at all. No request is made to TikTok, Snap or Reddit, no identifier is set, and none of the three receives anything about your visit.

**The Meta Pixel is present on every page, whether or not you accept cookies.** We advertise on Facebook and Instagram, which Meta operates, and this is the one advertising pixel we run without waiting for your choice on the cookie banner. We are telling you this plainly rather than describing it as held back, because it is not. On every page it sends Meta your page views together with the technical data any web request carries — IP address, browser and device type, referring page — and it sets an identifier in your browser that Meta uses to recognise the same browser on later visits. It also reports the same shopping actions as TikTok and Snap — product viewed, added to cart, checkout begun, order paid — with the product identifier, quantity, price, order value and currency. Meta uses this to report advert performance to us and, in line with its own privacy policy, for its own purposes including advert targeting.

**Meta receives a hash of who you are.** While you are signed in, the pixel is initialised with a one-way SHA-256 hash of your email address and a second hash of your internal account number, generated on our server so your actual address is never handed to code running in your browser. When an order is confirmed as paid, our server also reports the purchase to Meta directly and includes one-way SHA-256 hashes of the email address, phone number, first and last name, city, state, postal code and country used for that order, together with the browser identifiers Meta's own pixel set. Meta uses these to match the visit or the purchase to an advert you saw, including on another device. Meta's own setup instructions offer a field for the plain email address, to be hashed in your browser; we do not use it, and our code refuses to place anything that is not already a hash in that position. Everything said above about what a hash is and is not applies here in the same way. Our server also repeats the product views, cart additions and checkouts your browser has already reported, under the same event identifier, so Meta counts each once.

**How to stop it.** Declining cookies does not stop the Meta Pixel. You can block it with a content-blocking browser extension, use Meta's own advertising controls in your Facebook or Instagram settings, or ask us to stop matching your details using the contact details above. Residents of California and other states with a right to opt out of the sharing of personal information for targeted advertising may exercise that right by contacting us the same way.

**Omnisend is present on every page, whether or not you accept cookies.** Omnisend is our marketing email and SMS service provider: it sends the marketing email and text messages you agree to receive from us, and its website script is loaded on every page without waiting for your choice on the cookie banner — the same decision we made for the Meta Pixel, and we are telling you this plainly rather than describing it as held back, because it is not. On every page the script sends Omnisend your page views together with the technical data any web request carries — IP address, browser and device type, referring page — and sets two identifiers in your browser: one for the session, which expires after thirty minutes of inactivity, and one for the visitor, which lasts a year. Omnisend uses these to show our sign-up form, to let us see which pages our subscribers browse and send automated messages based on that browsing, and to connect a visit to your contact record if you sign up through one of its forms or arrive through a link in one of our marketing messages. The script itself is told about page views only and is never handed your email address by code running in your browser.

**What our server sends Omnisend.** Separately from the script, our server sends Omnisend your email address; the name and postal address on your orders; your phone number, only where you have given SMS marketing consent; your marketing consent status for email and SMS and the date and time it was given or withdrawn; your order history (the products, amounts and dates); the contents of your cart; and, while you are signed in, the products you view; whether you have confirmed that you are 21 or over and buying for research use; your referral code; and any discount code or gift we have issued to you, so that a message can show it. Omnisend receives these so that it can send the marketing email and SMS you agreed to and measure how they perform — for example, to remind you about a cart you left, to tell you about the batch reports for what you bought, and to stop sending once you unsubscribe. Omnisend processes what it receives on our behalf, in line with its own privacy policy, and does not use it for its own marketing. Until the move to Omnisend is complete, some marketing email is still sent through Resend as well. Transactional email — order confirmations, shipping and delivery updates, refunds, password and account security messages — is not marketing and is sent through Resend, our transactional email provider, not through Omnisend.

**How to stop Omnisend.** Declining cookies does not stop the Omnisend script. You can block it with a content-blocking browser extension. Unsubscribing from our marketing email, or replying STOP to a text message, stops those messages; you can also untick the marketing boxes in your account settings, or ask us to stop sharing your details using the contact details above.

**The Google Ads tag works differently, and this is the one place our answer is not "nothing loads".** We also advertise on Google, and Google's tag (gtag.js) is present on every page rather than appearing only after you accept. What your choice controls is not whether it loads but what it is permitted to do, using Google's consent mode.

**Before you accept — and permanently, if you decline — every storage permission is set to denied.** No advertising cookie is written. No identifier is stored in your browser or sent to Google. Nothing is shared for ads personalisation. What Google does receive is a single cookieless signal that a page was viewed, carrying the technical data any web request carries — IP address, browser and device type, referring page — with nothing tying it to you, to your other visits, or to any advert. We are telling you this plainly rather than describing the tag as switched off, because it is not.

**If you accept**, those permissions are granted: Google may then store an identifier in your browser and use your page views to report advert performance to us, to build the remarketing audiences our adverts are shown to and, in line with its own privacy policy, for its own purposes. If you accept and later change your mind, the permissions are set back to denied straight away, in every tab.

Either way the tag remains the narrowest of the advertising platforms on what it is told, but it is no longer told nothing. **The one shopping action we report to Google is a completed purchase.** When an order is paid, the tag reports the amount paid, the currency, and a reference for the order — so that we can tell which adverts lead to sales. It is still not told which product pages you view, when you add an item to the cart, or when you begin checkout, and it receives no product identifier and no quantity; the other advertising platforms above receive all of those. The order reference is there so that the same purchase is never counted twice if you reopen or forward your confirmation link — it identifies the order, not you. This report is sent whatever you choose on the banner: if you have not accepted, it goes as the same cookieless signal described above, with no advertising cookie and no identifier. Nothing identifying you is sent at any consent setting. Google's own setup offers a field for your email address, under the name Enhanced Conversions; we do not use it, so Google receives neither a plain address nor a hash of one.

We do not run any advertising or marketing tracking technology beyond the six named above. If we add one, this policy and our Cookie Policy will be updated to name the platform, the data shared and the purpose before it is switched on — as they were for the Google tag, the Meta Pixel and Omnisend above.
...
**Who delivers them, and where your number goes.** Our text messages are sent through Omnisend, our marketing email and SMS service provider, which receives your mobile number and your SMS consent record only once you have opted in, and only in order to deliver the messages you agreed to on our behalf. A number given at checkout or for an order is not SMS consent and is not used for marketing texts. Your mobile phone number and your SMS opt-in consent will not be shared with, or sold to, any third party or affiliate for their own marketing purposes.

**Opting out.** Reply STOP to any message to cancel at any time, or untick the SMS box in your account settings. Reply HELP for help, or contact ${email}. We record the date and time you gave and withdrew consent, and pass the withdrawal to Omnisend, so no further marketing texts are sent.
...
Reply STOP at any time to cancel; you will receive a single confirmation message and no further texts. Reply HELP for help, or contact ${email}. Messages are delivered through Omnisend, our marketing email and SMS service provider. Your mobile number is handled as described in our Privacy Policy and is never shared with third parties for their marketing.
...
**Advertising — three pixels, only if you accept.** The TikTok Pixel, the Snap Pixel and the Reddit Pixel measure whether our adverts lead to visits and orders. Each sets an identifier in your browser and sends its platform your page views together with the technical data any web request carries, plus shopping actions — product viewed, added to cart, order paid — and Reddit receives a one-way hash of your email address while you are signed in. Declining means none of them is ever loaded, so no request reaches TikTok, Snap or Reddit and no identifier is set.

**The Meta Pixel — always present, and not controlled by this banner.** Meta's pixel loads on every page whether you accept or decline, sets an identifier in your browser, and sends Meta your page views and shopping actions. While you are signed in it also receives a one-way hash of your email address and account number, and on a paid order our server sends Meta hashes of the email address, phone number, name and postal address on the order. Declining cookies does not stop it; see the Privacy Policy for how to opt out.

**Omnisend — always present, and not controlled by this banner.** Omnisend is our marketing email and SMS service provider, and its script loads on every page whether you accept or decline. It sets a session identifier that expires after thirty minutes of inactivity and a visitor identifier that lasts a year, and sends Omnisend the pages you view so it can show our sign-up form, let us see what our subscribers browse, and connect a visit to your contact record if you sign up through one of its forms or arrive through a link in one of our marketing messages. The script itself reports page views only and is never handed your email address by code running in your browser. Separately, our server sends Omnisend your email address, your phone number where you have given SMS consent, your marketing consent and its date, your order history, your cart contents and, while you are signed in, the products you view, so that it can send and measure the marketing you agreed to; the Privacy Policy describes this in full. Declining cookies does not stop it; see the Privacy Policy for how to opt out.

**The Google Ads tag — always present, but denied by default.** This one is not held back until you accept, so we are not claiming it is. Google's tag loads on every page; what your choice controls is what it may do. Until you accept, every storage permission is denied: no advertising cookie, no identifier stored or sent, nothing shared for ads personalisation. Google receives only a cookieless signal that a page was viewed, with nothing tying it to you or to any other visit. Accepting grants those permissions; declining, or changing your mind later, sets them back to denied immediately. The one shopping action it is told about is a completed order: when you pay, the tag reports the amount, the currency and a reference for that order, so we can tell which adverts led to sales. It is never told your email address, and never which products you viewed or added to your cart. That report is sent whatever you choose here — until you accept, it carries no cookie and no identifier.
