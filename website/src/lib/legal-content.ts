...
When you accept, six things run: our own first-party analytics, which records page views and store events to our own database; Vercel Analytics, a privacy-focused measurement service provided by our hosting provider; the TikTok Pixel; the Snap Pixel; the Reddit Pixel; and the Omnisend script, which supports our email and text-message marketing and is described in its own section below. Two more — the Meta Pixel and the Google Ads tag — are present whether or not you accept, and each is described in its own section below so that nothing here overstates what declining does.
...
**Omnisend.** We use Omnisend for our email and text-message marketing, and its website script loads only if you accept cookies. When it does, it sends Omnisend your page views together with the technical data any web request carries — IP address, browser and device type, referring page — and sets two identifiers in your browser: one for the session, which expires after thirty minutes of inactivity, and one for the visitor, which lasts a year. Omnisend uses these to show our sign-up form, to let us see which pages our subscribers browse and send automated messages based on that browsing, and to connect a visit to your contact record if you sign up through one of its forms or arrive through a link in one of our marketing messages. It is told about page views only: it receives no shopping actions, product identifiers or order values, and this site never hands it your email address — Omnisend learns it only from you, when you subscribe. If you decline, the script is never fetched, so Omnisend receives nothing about your visit. Omnisend processes what it receives in line with its own privacy policy.
...
**Omnisend — only if you accept.** Omnisend sends our marketing emails and text messages, and its script loads only if you choose Accept. It sets a session identifier that expires after thirty minutes of inactivity and a visitor identifier that lasts a year, and sends Omnisend the pages you view so it can show our sign-up form, let us see what our subscribers browse, and connect a visit to your contact record if you sign up through one of its forms or arrive through a link in one of our marketing messages. It is never told about shopping actions or order values, and this site never sends it your email address. Declining means it is never loaded, so Omnisend receives nothing about your visit.
