...
When you accept, six things run: our own first-party analytics, which records page views and store events to our own database; Vercel Analytics, a privacy-focused measurement service provided by our hosting provider; the TikTok Pixel; the Snap Pixel; the Reddit Pixel; and the Meta Pixel.
...
**The Meta Pixel.** We also advertise on Facebook and Instagram, which Meta operates, and this pixel does the same job for those adverts. It loads only if you accept cookies, and it sends Meta your page views together with the technical data any web request carries — IP address, browser and device type, referring page — and an identifier Meta stores in your browser. Meta uses this to report advert performance to us and, in line with its own privacy policy, for its own purposes including advert targeting.

It reports the same shopping actions as TikTok and Snap — product viewed, added to cart, checkout begun, order paid — with the product identifier, quantity, price, order value and currency. It does not receive your name, your address, your email address, your phone number, or the contents of any message you send us. Meta's own setup instructions offer a field for the plain email address and phone number, to be hashed in your browser; we do not use it, and our code refuses to place anything in that position. If we ever send Meta a hash of your email address on a paid order, as we do for TikTok and Snap, this policy will say so first.

If you decline cookies, none of these four pixels are loaded at all. No request is made to TikTok, Snap, Reddit or Meta, no identifier is set, and none of the four receives anything about your visit.
...
**Advertising — four pixels, only if you accept.** The TikTok Pixel, the Snap Pixel, the Reddit Pixel and the Meta Pixel measure whether our adverts lead to visits and orders. Each sets an identifier in your browser and sends its platform your page views together with the technical data any web request carries, plus shopping actions — product viewed, added to cart, order paid — and Reddit receives a one-way hash of your email address while you are signed in. Declining means none of them is ever loaded, so no request reaches TikTok, Snap, Reddit or Meta and no identifier is set.
