...
export default function PartnerPendingPage() {
  return (
    <div className="vl-page-shell min-h-screen bg-[radial-gradient(circle_at_top_right,rgba(34,211,238,0.1),transparent_56%),linear-gradient(150deg,#04060f_0%,#0a1222_50%,#050911_100%)] px-4 py-12 text-zinc-100 sm:px-6 lg:px-8">
      <div className="vl-panel mx-auto max-w-2xl rounded-[2rem] p-8 text-center">
        <p className="text-xs uppercase tracking-[0.34em] text-cyan-300/85">Application Received</p>
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          ...
          <Link href="/partner" className="vl-focus-ring rounded-full bg-gradient-to-r from-cyan-300 via-blue-200 to-indigo-200 px-6 py-3 text-sm font-semibold text-zinc-950">Back to Partner Program</Link>
        </div>
      </div>
    </div>
  );
