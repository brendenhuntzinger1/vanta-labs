# BLOCK F-B — Financial reporting (session `claude/audit-blocks-f-e-8jxi9v`)
...
## F-B-01 — Three surfaces labelled "paid orders" report three different numbers
...
## F-B-02 — The fourth copy of the total formula HAS drifted, by exactly one cent
...
## F-B-03 — Sales tax: a partial refund vanished, and a full refund produced a negative liability
...
## F-B-04 — The customer's invoice does not add up, on three real orders today
...
## F-B-05 — Two money reads could show part of the store and say nothing
...
Phase 10, and is recorded here only because F-B-02's analysis surfaced it.
